...
<rapid:override name="content">
    ...
    <!-- 内容主体区域 -->
        <div style="padding: 15px;">
            <div class="wrapper">
                <div class="middle">
                    <h1 style="padding: 50px 0 20px;">部门领料明细表</h1>
                        ...
                        <table class="gridtable" style="width:100%;text-align: center;">
                            <tr>
                                <c:if test="${deptMatDetailPageInfo.hasPreviousPage}">
                                    <td>
                                        <a href="${pageContext.request.contextPath}/department/departmentDetail?page=${deptMatDetailPageInfo.prePage}">前一页</a>
                                    </td>
                                </c:if>
                                <c:forEach items="${deptMatDetailPageInfo.navigatepageNums}" var="nav">
                                    ...
                                    <c:if test="${nav != deptMatDetailPageInfo.pageNum}">
                                        <td>
                                            <a href="${pageContext.request.contextPath}/department/departmentDetail?page=${nav}">${nav}</a>
                                        </td>
                                    </c:if>
                                </c:forEach>
                                <c:if test="${deptMatDetailPageInfo.hasNextPage}">
                                    <td>
                                        <a href="${pageContext.request.contextPath}/department/departmentDetail?page=${deptMatDetailPageInfo.nextPage}">下一页</a>
                                    </td>
                                </c:if>
                            </tr>
                        </table>
